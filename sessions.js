...
module.exports = class Sessions {
    ...
    static async conexao(sessionName){
        var session = Sessions.getSession(sessionName);
    ...
    static async setup(sessionName) {
        ...
        await session.client.then(client => {
            ...
            client.onMessage(async (message) => {
                ...
                //aqui vc pode programar o bote caso alguem diga algo....
                 if (message.isMedia === true || message.isMMS === true){
                    client.sendText(message.from, 'Sou um bot');
                 }
    ...
    static async sendText(sessionName, number, text) {
        var session = Sessions.getSession(sessionName);
        if (session) {
            let checar = Sessions.conexao(sessionName);//Obriga a mudar para CONNECTED
